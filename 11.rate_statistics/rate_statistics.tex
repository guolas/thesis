\chapter[Rate Statistics]{Achievable Rate and Fairness in Coordinated Base Station Transmission}\label{ch:rate_statistics}
...
allocation strategies described in \refs{sec:power_allocation} in order to
